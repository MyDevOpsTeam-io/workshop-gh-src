...
reported via the collective email address, `workshop-moderation@mydevopsteam.io`, which
will go to all moderators, or by contacting individual moderators via
`alfred.valderrama@mydevopsteam.io`, which will go only to Alfred Valderrama.
